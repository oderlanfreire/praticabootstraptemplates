    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Gráfico'), ('lni-mobile', 'Mobile'), ('lni-users', 'Usuários'), ('lni-rocket', 'Foguete'), ('lni-layers', 'Design')], max_length=12, verbose_name='Icone')),
            ],
            options={
